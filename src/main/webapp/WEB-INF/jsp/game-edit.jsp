...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  placeholder="" id="orderNum" name="orderNum">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">关注人数：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" id="number" name="number" value="1800">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" id="createTime" value="2018-11-30 20:30" readonly>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="skin-minimal">
                <%--<div class="check-box">--%>
                    <%--<input type="checkbox" id="checkbox-1" name="type" value="moba">--%>
                    <%--<label for="checkbox-1">moba</label>--%>
                <%--</div>--%>
                <%--<div class="check-box">--%>
                    <%--<input type="checkbox" id="checkbox-2" name="type" value="手游">--%>
                    <%--<label for="checkbox-2">手游</label>--%>
                <%--</div>--%>
                <%--<div class="check-box">--%>
                    <%--<input type="checkbox" id="checkbox-3" name="type" value="fps">--%>
                    <%--<label for="checkbox-3">fps</label>--%>
                <%--</div>--%>
                <%--<div class="check-box">--%>
                    <%--<input type="checkbox" id="checkbox-4" name="type" value="养成">--%>
                    <%--<label for="checkbox-4">养成</label>--%>
                <%--</div>--%>
...
<script type="text/javascript">
    $(function(){
        var gameData=parent.gameData;
        var types = gameData.types;
        getAllTypes(types);
        $("#gameId").val(gameData.id);
        $("#gameName").val(gameData.gameName);
        $("#orderNum").val(gameData.orderNum);
        $("#number").val(gameData.number);
        $("#createTime").val(date(gameData.createTime));
        $("#photo").attr("src",gameData.photo);
        $("#photoSrc").val(gameData.photo);
...
//保存发布
    ...
    function getAllTypes(gameTypes){
            ...
            success: function (data) {
                if(data.code==1){
                    ...
                    for(var i=0;i<types.length;i++){
                        var $node = $(template.replace(forIdreg,"checkbox-"+i).replace(valuereg,types[i].type));
                        $checkNode.append($node);
                        if(gameTypes.indexOf(types[i].type)>-1){
